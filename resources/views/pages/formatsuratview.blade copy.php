                    ...
                    @csrf
                            ...
                            <div id="summernote_area">
                                <div class="form-group col-md-12">
                                    <label for="" class="control-label">Kepala Surat</label>
                                    <textarea name="kepalasurat" id="kepalasurat" class="summernote" >
                            ...
                            <div id="summernote_area">
                                <div class="form-group col-md-12">
                                    <label for="" class="control-label">Kaki Surat</label>
    ...
    $('body').on('click', '#update_formatsurat_btn', function(e){
        ...
        $.ajax({
            ...
            success: function (response) {                  
                    ...
                    $('#pengesahan option[value='+response.id+']').prop('selected', true);
                    $('#area_tabel_formatsurat').hide();
                    $('#area_form_formatsurat').show();
            }
        });           
